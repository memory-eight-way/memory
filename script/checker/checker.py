...
def get_score_10(w_quiz_line,w_base_line):
    ...
    li_q=w_quiz_line.split(" ")
    li_b=w_base_line.split(" ")
...
def make_result(quiz_lines ,base_lines):
    ...
    for w_chk_line_number in li_quiz:
        ...
        if w_score10==10:
            ...
            li_ret.append("SCORE10 :"+str(w_score10))
            li_ret.append("SCORE100:"+str(w_score100))
            li_ret.append("base:"+base_line)
            li_ret.append("ans :"+quiz_line)
        di_summary["TOTAL-SCORE10"] = di_summary["TOTAL-SCORE10"] +w_score10
        di_summary["TOTAL-SCORE100"] = di_summary["TOTAL-SCORE100"] + w_score100

    di_summary["AVERAGE-SCORE10"] = int(di_summary["TOTAL-SCORE10"] /len(li_quiz))
    di_summary["AVERAGE-SCORE100"] = int(di_summary["TOTAL-SCORE100"]  /len(li_quiz))
...
def main():
    ...
    #quiz_folder="F:/practice/daily/2019/201902/20190225_theartofwar/quiz/lv01_space"
